...
/*Table structure for table `mc_imports_subscribers` */

DROP TABLE IF EXISTS `mc_imports_subscribers`;

CREATE TABLE `mc_imports_subscribers` (
  `subscriber_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `import_id` int(11) NOT NULL,
  `email` varchar(150) NOT NULL,
  `import_status` tinyint(4) DEFAULT '0',
  `mc_subscriber_id` varchar(40) DEFAULT NULL,
